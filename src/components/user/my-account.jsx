    ...
    <>
      ...
      <div className="container mx-auto my-5">
        <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-5 place-items-center">
          ...
          <Link to="#" className="border border-purple-700 rounded-lg bg-purple-500 hover:bg-purple-800 px-3 py-3 w-3/5 sm:h-52 lg:h-44">
              <div>
          ...
          <Link to="#" className="border border-green-700 rounded-lg bg-green-500 hover:bg-green-800 px-3 py-3 w-3/5 sm:h-52 lg:h-44">
              <div>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10">
          ...
          <Link to="/my-account/:user_id/hosted_workouts" className="border border-red-700 rounded-lg bg-red-500 hover:bg-red-800 px-3 py-3 w-3/5 sm:h-52 lg:h-44">
              <div>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10">
