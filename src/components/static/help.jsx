    ...
    <div className="container mx-auto my-5">
      ...
      <div className="flex flex-wrap mt-1 mb-5">
        <div className="w-full md:w-1/2 p-2">
          <div
            className="h-full p-5 rounded-lg shadow-lg bg-gray-50"
          >
            <div>
              <h5 className="text-center text-lg font-semibold mb-4">Je suis propriétaire</h5>
              <div>
                ...
                <p>
                  Le jour venu, vous accueillez les locataires pour qu&apos;ils
                  puissent disposer librement des équipements.
                </p>
                <p>4. Je perçois le règlement</p>
                <p>
                  Vous recevez automatiquement le montant de la transaction sur
                  votre compte bancaire dans un délai de 3 à 10 jours.
                </p>
        ...
        <div className="w-full md:w-1/2 p-2">
          ...
          >
            <div>
              <h5 className="text-center text-lg font-semibold mb-4">Je suis locataire</h5>
              <div>
                ...
                <p>
                  Réservez les équipements ou l&apos;infrastructure en sélectionnant
                  la date de la location. Vous ne serez pas facturé
                  immédiatement.
                </p>
                <p>3. Je prépare ma venue</p>
                <p>
                  Une fois votre demande de réservation acceptée, vous pourrez
                  prendre connaissance de l&apos;adresse exacte de la location. Il ne
                  vous reste plus qu&apos;à préparer vos muscles !
                </p>
                <p>4. Je profite de ma séance de sport</p>
                <p>
                  Le jour J est arrivé ! Profitez d&apos;une séance de sport avec un
                  matériel de qualité.
                </p>
                <p>5. Je laisse un avis sur la plateforme</p>
                <p>
                  C&apos;est déjà fini... N&apos;hésitez pas à laisser un commentaire sur
                  la qualité de l&apos;accueil que vous avez reçu.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="w-full md:w-1/2 p-2">
          ...
          >
            <div>
              <h5 className="text-center text-lg font-semibold mb-4">Je suis propriétaire</h5>
              <div>
                <p>1.Est-ce qu&apos;un locataire peut me régler en liquide ?</p>
                <p>
                  Non, n&apos;acceptez jamais une location en dehors du site. Aucun
                  règlement en liquide n&apos;est autorisé pour payer une location.
                  Pourquoi ? Parce qu&apos;en cas d&apos;accident ou de vol, vous ne
                  serait pas assurée par Keella. Le paiement en ligne est un
                  gage de sécurité pour vous, ne prenez pas de risques inutiles
                  en contournant le paiement sur le site.
                </p>
                <p>2. Quand suis-je crédité ?</p>
                <p>
                  Vous serez crédité sur votre compte par virement entre 3 et 5
                  jours après la réalisation de la réservation.
                </p>
                <p>
                  3. Que se passe-t-il si le locataire ne se présente pas ou est
                  en retard ?
                </p>
                <p>
          ...
          >
            <div>
              ...
              <div>
                ...
                <p>
                  Actuellement, Keella n&apos;accepte que les paiements par carte
                  bancaire. Tout paiement en espèces ou en dehors du site est
                  considéré comme une infraction aux conditions générales
                  d&apos;utilisation et constitue un motif de bannissement de la
                  communauté. Utiliser notre plateforme permet d&apos;une part la
                  protection de vos données, et d&apos;autre part une assurance en
                  cas de problème.
                </p>
                ...
                <p>
                  ...
                  libres, il est donc conseillé d&apos;envoyer un message à plusieurs
